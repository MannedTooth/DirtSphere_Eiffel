...
extern EIF_TYPED_VALUE F963_7094(EIF_REFERENCE);
extern EIF_TYPED_VALUE F963_7095(EIF_REFERENCE);
extern EIF_TYPED_VALUE F963_7096(EIF_REFERENCE);
extern void F963_7097(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F963_7094 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 962, Current, 1, 0, 13281);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(962, Current, 13281);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4961, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F963_7095)
EIF_TYPED_VALUE F963_7095 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 13282);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(962, Current, 13282);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F963_7096)
EIF_TYPED_VALUE F963_7096 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 13283);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(962, Current, 13283);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80003C4, 0,0); /* Result */
...
void F963_7097 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 962, Current, 0, 1, 13284);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(962, Current, 13284);
...
{
	GTCX
	RTOTS (7095,F963_7095)
	RTOTS (7096,F963_7096)
}
